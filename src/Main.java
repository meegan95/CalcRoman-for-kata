...
//      Заполняем символьный массив символами строки которую ввел пользователь и по ходу ловим знак операции
           ...
           if ((stable00.codePointAt(0)-(string03.codePointAt(0))>15) ||(string03.codePointAt(0)-(stable00.codePointAt(0))>15)){
               System.out.println("Невозможно испальзовать арабские и римские цифры одновременно");
               System.exit(1);
           }
            ...
            if (number1 < 0 && number2 < 0) {
                ...
                if (result==0) {
                    System.out.println("В римских цифрах не может быть нуля и отрицательных чисел");
                    System.exit(1);
                }
            ...
            if (number1 > 10 || number2 > 10 || number1 == 0 || number2 == 0) {
                result = 0;
                System.out.println("Введите значения от 1 до 10");
                System.exit(1);
            } else {
                result = calculated(number1, number2, operation);
